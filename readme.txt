...
= 1.5 - March 28, 2025 =
* New - Option to use an alternative filename for matomo.php and matomo.js
...
Get the latest version for improved tracking in Matomo.
...
1. Dashboard in WordPress
2. Dashboard in WordPress
3. Matomo Stats - Actions
4. Matomo Stats - Campaigns